...
namespace System.Data.SQLite
{
    ...
    public class SQLiteHelper
    {
        ...
        /// <param name="dic">添加的数据</param>
        /// <param name="returnID">如果为TRUE，返回自增长ID，如果为FALSE，返回受影响行数</param>
        /// <returns>INT型返回值</returns>
        public int Insert(string tableName, Dictionary<string, object> dic, bool returnID)
        {
        ...
        {
           return Insert(tableName, dic, false);
        }
